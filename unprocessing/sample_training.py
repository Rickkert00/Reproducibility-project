...
def copy_sample(sample_size, set_size, set_folder, sample_folder):
    ...
    for i in range(sample_size):
        ...
        img = tf.io.read_file(os.path.join(set_folder, f"r_{current_index}.png"))
        current_transforms_dict["frames"].append(total_transforms_dict["frames"][current_index])
        tf.io.write_file(os.path.join(sample_folder, f"r_{current_index}.png"), img)
...
if __name__ == '__main__':
    ...
    train_folder = "../data/our_nerf_synthetic/train/"
    test_folder = "../data/our_nerf_synthetic/test/"
